...
## 서비스 정책
- **객체 스토리지(Object Storage)**: `external.oracle.OracleStorageUtil`을 통해 Oracle 스토리지를 활용합니다.
...
- **파일 다운로드**: 채점 시스템 등에서 파일을 다운로드할 때 `external.oracle.OracleStorageUtil`을 사용합니다.
